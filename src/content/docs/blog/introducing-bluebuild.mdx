...
4. Detach your custom image repository, which is most likely a fork of the upstream template.
...
5. Clean up the git branch structure by removing the `template` branch and renaming `live` to `main`.
