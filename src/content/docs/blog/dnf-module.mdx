...
- Changes to the `install:` and `remove:` sections
  - The `rpm-ostree` module used to have `install:` and `remove:` sections that were a lists of packages to install/remove.
  ...
  - The list of packages also supports including sublists of packages to install from a specific repostory or with specific flags.
- Changes to the `replace:` section
  - While the syntax is remains the same, the `replace:` section in the `dnf` module supports setting flags for the package manager.
- New sections
