...
description: Learn the basics of BlueBuild
---
...
All you need to get started with BlueBuild is a small amount of experience with of git and text editors, and some baseline Linux knowledge like what package managers are and how to use a terminal. Everything else you can learn along the way or by asking our wonderful [community](/community). You don't really need any previous knowledge of containers, Containerfiles, GitHub actions, or any of the other underlying technologies, but you have the opportunity to learn through reading our documentation and source code.
