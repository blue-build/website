...
The [OCI](https://opencontainers.org/) image upon which all your customizations will be based. Only atomic Fedora images and those based on them are officially supported. Universal Blue is recommended. uBlue images can be found on the [uBlue website](https://universal-blue.org/images/). BlueBuild-built images can be used as well. 
