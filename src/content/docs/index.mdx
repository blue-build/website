...
<CardGrid stagger>
    ...
    <Card title="Build on the best" icon="material-symbols:stacks-rounded">
        ...
        Blue](https://universal-blue.org/)'s awesome base, with the option to
        build on [atomic Fedora
...
-   It is more accessible and helps onboard new users.
    ...
    -   New curious tinkerers won't be _robbed_ of the experience of learning a new generalizeable skill, as we also provide [documentation for setting up the pipelines and building container images from scratch](/how-to/from-scratch/).
