...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      customCss: ['@fontsource/atkinson-hyperlegible/400.css', '@fontsource/atkinson-hyperlegible/700.css', '@fontsource-variable/rubik', '@fontsource/ibm-plex-mono', './src/tailwind.css'],
      components: {
